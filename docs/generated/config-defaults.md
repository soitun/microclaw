...
| `aux_models` | `AuxModels` | `serde(default)` | `(serde default)` |
...
| `memory_graph_recall_enabled` | `bool` | `default_memory_graph_recall_enabled` | `true` |
| `memory_graph_max_hops` | `usize` | `default_memory_graph_max_hops` | `2` |
| `memory_graph_max_triples` | `usize` | `default_memory_graph_max_triples` | `10` |
...
| `sleep_time` | `SleepTimeConfig` | `serde(default)` | `(serde default)` |
| `interjection` | `InterjectionConfig` | `serde(default)` | `(serde default)` |
...
| `rtk` | `RtkConfig` | `serde(default)` | `(serde default)` |
...
| `web_search` | `SearchProviderConfig` | `serde(default)` | `(serde default)` |
| `output_guardrail` | `OutputGuardrailConfig` | `serde(default)` | `(serde default)` |
